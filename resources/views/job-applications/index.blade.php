            ...
            @forelse ($jobApplications as $jobApplication)
                <div class="bg-gray-900 p-4 rounded-lg">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @if($jobApplication->resume->file_uri)
                            <a href="{{ Storage::disk('cloud')->url($jobApplication->resume->file_uri) }}" target="_blank"
                                class="text-indigo-500 hover:text-indigo-600">View Resume</a>
                        @else
                            <span class="text-gray-500">Resume file not available</span>
                        @endif
                    </div>
