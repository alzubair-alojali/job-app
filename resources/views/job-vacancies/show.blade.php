        ...
        <div class="bg-black shadow-lg rounded-lg p-6 max-w-7xl mx-auto">
            ...
            <div class="border-b border-white/10 pb-6">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('job-vacancies.apply', $jobVacancy->id) }}" class="justify-center bg-gradient-to-r from-indigo-500 to-rose-500 text-white rounded-lg px-4 py-2 hover:from-indigo-600 hover:to-rose-600">
                            Apply Now
                        </a>
                    </div>
                </div>
